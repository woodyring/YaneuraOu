...
namespace {
  ...
  template<int Pt> inline
    Piece min_attacker(const Position& pos,const Bitboard(&bb)[PIECE_TYPE_BITBOARD_NB][COLOR_NB], const Square& to, const Bitboard& stmAttackers,
...
//:      Bitboard b = stmAttackers & bb[Pt];
  ...
  template<> inline
    ...
    Piece min_attacker<KING + 1>(const Position& pos, const Bitboard(&)[PIECE_TYPE_BITBOARD_NB][COLOR_NB], const Square&, const Bitboard&
